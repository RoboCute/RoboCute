...
**关键文件**:
- `rbc/tests/test_py_codegen/` - 代码生成测试和模板
- `xmake/py_codegen.lua` - xmake集成
...
- `f885964` - binary serde
- `be400bd` - simple archive impl for ozz asset
...
#### 物理节点 (原型)
- ⚠️ `UIPCSimNode` - UIPC物理模拟节点 (接口完成，实现待补充)
