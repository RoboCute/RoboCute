...
set_showmenu(false)
set_default(false)
add_deps('lc_toolchain', 'lc_py_include', 'lc_py_linkdir', 'lc_py_libs', 'rbc_py_bin', 'lc_use_lto', 'lc_warnings',
    'rbc_editor', 'rbc_unity_build', 'rbc_pch', 'rbc_tools', 'rbc_plugins', 'rbc_tests', 'rbc_oidn', 'rbc_urdf')
