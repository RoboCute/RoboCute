...
class RenderSettings:
    ...
    def get_ao_max_radius() -> float: ...
    def set_ao_max_radius(value: float) -> None: ...
    def get_ao_atten_pow() -> float: ...
    def set_ao_atten_pow(value: float) -> None: ...
...
class RBCContext:
    ...
    def init_transparent_display(
        self,
        name: str, size: uint2, pos: uint2, opacity: float, topmost: bool, click_through: bool
    ) -> None: ...
