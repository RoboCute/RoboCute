...
class RenderSettings:
    ...
    def get_alpha_cull() -> AlphaCull: ...
    def set_alpha_cull(value: AlphaCull) -> None: ...
    ...
    def get_probe_initial_medium() -> bool: ...
    def set_probe_initial_medium(value: bool) -> None: ...
    def get_spectrum_accumulation_space() -> SpectrumAccumulationSpace: ...
    def set_spectrum_accumulation_space(value: SpectrumAccumulationSpace) -> None: ...
    ...
    def get_reject_sampling() -> bool: ...
    def set_reject_sampling(value: bool) -> None: ...
...
class SkeletonResource(Resource):
    ...
    # Validation methods
    def ensure_parents_exist(bone_indices: Vector[int]) -> Vector[int]: ...
...
class AnimSequenceResource(Resource):
    ...
    def set_anim_name(name: str) -> None: ...
...
class SkelMeshComponent(Component):
    # Resource binding
    def set_ref_skel_mesh(skel_mesh: SkelMeshResource) -> None: ...
    ...
    # State queries
    def get_runtime_mesh() -> MeshResource: ...
    def is_enabled() -> bool: ...
    ...
    # Bone transform access for physics
