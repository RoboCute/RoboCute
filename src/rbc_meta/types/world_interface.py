...
class Scene(Resource):
    def get_entity(guid: Ref[Const[GUID]]) -> Entity: ...
    def get_or_add_entity(guid: Ref[Const[GUID]]) -> Entity: ...
    def update_data() -> None: ...
    def remove_entity(guid: Ref[Const[GUID]]) -> None: ...
...
class Project:
    ...
    # TODO: more import
    def load_resource(guid: Ref[Const[GUID]], async_load: bool) -> TextureResource: ...

    def scan_project() -> None: ...
    def get_file_meta(type_id: Ref[Const[GUID]], dest_path: str) -> FileMeta: ...
