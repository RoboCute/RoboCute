...
class EditorService:
    ...
    def __init__(self, scene: 'Scene', resource_manager: Optional[ResourceManager] = None):
        """
    ...
    def stop(self):
        ...
        with self._editors_lock:
            for editor in self._editors.values():
                self._send_to_editor(editor.id, {
    ...
    def _handle_command(self, command: EditorCommand):
        ...
        try:
            if cmd_type == 'request_resource_sync':
                ...
                self._send_to_editor(command.editor_id, {
    ...
    def _cleanup_dead_connections(self):
        ...
        with self._editors_lock:
            dead_editors = [
                editor_id for editor_id, conn in self._editors.items()
