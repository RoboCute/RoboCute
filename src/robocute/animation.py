...
class AnimationSequence:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'AnimationSequence':
        ...
        return cls(
            ...
            keyframes=[AnimationKeyframe.from_dict(kf) for kf in data.get("keyframes", [])]
        )
...
class AnimationClip:
    ...
    def add_sequence(self, sequence: AnimationSequence):
        ...
        self.sequences = [s for s in self.sequences if s.entity_id != sequence.entity_id]
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'AnimationClip':
        ...
        return cls(
            name=data["name"],
            sequences=[AnimationSequence.from_dict(seq) for seq in data.get("sequences", [])],
