...
def atomic_compare_exchange(
    *argnodes,
):  # (self, idx: int, expected: int, desired: int):
...
def atomic_fetch_add(*argnodes):  # (self, idx: int, val: int):
    ...
    return _atomic_call(
        float, "ATOMIC_FETCH_ADD", argnodes[0], argnodes[1], argnodes[2]
    )
...
def atomic_fetch_sub(*argnodes):  # (self, idx: int, val: int):
    ...
    return _atomic_call(
        float, "ATOMIC_FETCH_SUB", argnodes[0], argnodes[1], argnodes[2]
    )
...
def atomic_fetch_min(*argnodes):  # (self, idx: int, val: int):
    ...
    return _atomic_call(
        float, "ATOMIC_FETCH_MIN", argnodes[0], argnodes[1], argnodes[2]
    )
...
def atomic_fetch_max(*argnodes):  # (self, idx: int, val: int):
    ...
    return _atomic_call(
        float, "ATOMIC_FETCH_MAX", argnodes[0], argnodes[1], argnodes[2]
    )
