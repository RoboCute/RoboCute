...
class Denoiser;
class DenoiserExt : public vstd::IOperatorNewBase {
public:
...
class DenoiserExtDerive : public DenoiserExt {
...
class DXOidnDenoiserExt : public DenoiserExtDerive<DenoiserExt::Tag::DirectX> {
...
#ifdef OIDN_EXPORT
#define OIDN_API _declspec(dllexport)
#else
#define OIDN_API _declspec(dllimport)
#endif
#else
#define OIDN_API
#endif
