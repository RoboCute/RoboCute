...
public:
    // Layout Management
    [[nodiscard]] virtual QString currentLayoutId() const = 0;
    [[nodiscard]] virtual QStringList availableLayouts() const = 0;
    [[nodiscard]] virtual QJsonObject getLayoutMetadata(const QString &layoutId) const = 0;
    [[nodiscard]] virtual bool hasLayout(const QString &layoutId) const = 0;
    ...
    [[nodiscard]] virtual bool isViewVisible(const QString &viewId) const = 0;
