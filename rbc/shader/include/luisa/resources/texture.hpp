...
struct [[builtin("image")]] Image {
	...
	[[callop("TEXTURE_READ")]] vec<T, 4> read(uint2 coord);
	[[callop("TEXTURE_WRITE")]] void write(uint2 coord, vec<T, 4> val);
...
struct [[builtin("volume")]] Volume {
	...
	[[callop("TEXTURE_READ")]] vec<T, 4> read(uint3 coord);
	[[callop("TEXTURE_WRITE")]] void write(uint3 coord, vec<T, 4> val);
...
struct [[builtin("image")]] Image<float, CacheFlags::ReadOnly> {
	[[callop("TEXTURE_READ")]] float4 read(uint2 coord);
	[[callop("TEXTURE_SIZE")]] uint2 size();
...
struct [[builtin("volume")]] Volume<float, CacheFlags::ReadOnly> {
	[[callop("TEXTURE_READ")]] float4 read(uint3 coord);
	[[callop("TEXTURE_SIZE")]] uint3 size();
