...
auto arg_types = {::luisa::compute::Type::from(luisa::string_view(src_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(bloom_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(tonemap_volume_desc, 16)),::luisa::compute::Type::from(luisa::string_view(args_desc, 139)),::luisa::compute::Type::from(luisa::string_view(exposure_buffer_desc, 13)),::luisa::compute::Type::from(luisa::string_view(result_desc, 16))};
