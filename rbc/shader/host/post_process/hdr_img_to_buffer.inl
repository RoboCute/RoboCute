...
char buffer_desc[14] = {98,117,102,102,101,114,60,102,108,111,97,116,62,0};
char img_desc[17] = {116,101,120,116,117,114,101,60,50,44,102,108,111,97,116,62,0};
char comp_desc[5] = {117,105,110,116,0};

auto arg_types = {::luisa::compute::Type::from(luisa::string_view(buffer_desc, 13)),::luisa::compute::Type::from(luisa::string_view(img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(comp_desc, 4))};
...
::luisa::compute::BufferView<float> buffer,
...
_cmd_encoder.encode_uniform(std::addressof(comp), 4, 4);
