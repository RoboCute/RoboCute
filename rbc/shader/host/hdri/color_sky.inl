...
char sky_color_desc[16] = {118,101,99,116,111,114,60,102,108,111,97,116,44,51,62,0};

auto arg_types = {::luisa::compute::Type::from(luisa::string_view(src_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(sky_color_desc, 15))};
...
::luisa::Vector<float,3> sky_color) {
...
_cmd_encoder.encode_uniform(std::addressof(sky_color), 16, 16);
