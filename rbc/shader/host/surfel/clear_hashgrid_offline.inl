...
auto arg_types = {::luisa::compute::Type::from(luisa::string_view(key_buffer_desc, 12)),::luisa::compute::Type::from(luisa::string_view(value_buffer_desc, 12)),::luisa::compute::Type::from(luisa::string_view(max_accum_desc, 4))};
