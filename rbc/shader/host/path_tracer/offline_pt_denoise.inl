...
char albedo_buffer_desc[14] = {98,117,102,102,101,114,60,102,108,111,97,116,62,0};
char normal_buffer_desc[14] = {98,117,102,102,101,114,60,102,108,111,97,116,62,0};
...
auto arg_types = {::luisa::compute::Type::from(luisa::string_view(g_vt_level_buffer_desc, 12)),::luisa::compute::Type::from(luisa::string_view(g_buffer_heap_desc, 14)),::luisa::compute::Type::from(luisa::string_view(g_image_heap_desc, 14)),::luisa::compute::Type::from(luisa::string_view(g_volume_heap_desc, 14)),::luisa::compute::Type::from(luisa::string_view(g_triangle_vis_buffer_desc, 12)),::luisa::compute::Type::from(luisa::string_view(g_accel_desc, 5)),::luisa::compute::Type::from(luisa::string_view(emission_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(gbuffers_desc, 62)),::luisa::compute::Type::from(luisa::string_view(albedo_buffer_desc, 13)),::luisa::compute::Type::from(luisa::string_view(normal_buffer_desc, 13)),::luisa::compute::Type::from(luisa::string_view(last_transform_buffer_desc, 17)),::luisa::compute::Type::from(luisa::string_view(multi_bounce_pixel_desc, 79)),::luisa::compute::Type::from(luisa::string_view(multi_bounce_pixel_counter_desc, 12)),::luisa::compute::Type::from(luisa::string_view(args_desc, 182)),::luisa::compute::Type::from(luisa::string_view(size_desc, 14))};
...
(sizeof(A1) == 48 && alignof(A1) == 4 && std::is_trivially_copyable_v<A1>)&&
...
::luisa::compute::BufferView<float> albedo_buffer,
::luisa::compute::BufferView<float> normal_buffer,
::luisa::compute::BufferView<::luisa::float4x4> last_transform_buffer,
::luisa::compute::BufferView<A1> multi_bounce_pixel,
::luisa::compute::BufferView<uint32_t> multi_bounce_pixel_counter,
A2 const & args,
::luisa::Vector<uint32_t,2> size) {
::luisa::compute::ComputeDispatchCmdEncoder _cmd_encoder(_shader->handle(), 15, _shader->uniform_size());
...
_cmd_encoder.encode_buffer(albedo_buffer.handle(),albedo_buffer.offset_bytes(),albedo_buffer.size_bytes());
_cmd_encoder.encode_buffer(normal_buffer.handle(),normal_buffer.offset_bytes(),normal_buffer.size_bytes());
