...
char specular_dist_img_desc[17] = {116,101,120,116,117,114,101,60,50,44,102,108,111,97,116,62,0};
char hitmv_img_desc[17] = {116,101,120,116,117,114,101,60,50,44,102,108,111,97,116,62,0};
...
auto arg_types = {::luisa::compute::Type::from(luisa::string_view(g_vt_level_buffer_desc, 12)),::luisa::compute::Type::from(luisa::string_view(g_buffer_heap_desc, 14)),::luisa::compute::Type::from(luisa::string_view(g_image_heap_desc, 14)),::luisa::compute::Type::from(luisa::string_view(g_volume_heap_desc, 14)),::luisa::compute::Type::from(luisa::string_view(g_triangle_vis_buffer_desc, 12)),::luisa::compute::Type::from(luisa::string_view(g_accel_desc, 5)),::luisa::compute::Type::from(luisa::string_view(emission_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(depth_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(mv_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(radiance_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(specular_dist_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(hitmv_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(specular_albedo_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(albedo_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(beta_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(normal_roughness_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(sample_flags_img_desc, 15)),::luisa::compute::Type::from(luisa::string_view(di_img_desc, 16)),::luisa::compute::Type::from(luisa::string_view(vbuffer_desc, 15)),::luisa::compute::Type::from(luisa::string_view(sample_desc, 4)),::luisa::compute::Type::from(luisa::string_view(spp_desc, 4)),::luisa::compute::Type::from(luisa::string_view(confidence_map_desc, 16)),::luisa::compute::Type::from(luisa::string_view(light_dirty_map_desc, 15)),::luisa::compute::Type::from(luisa::string_view(surfel_key_buffer_desc, 12)),::luisa::compute::Type::from(luisa::string_view(surfel_value_buffer_desc, 12)),::luisa::compute::Type::from(luisa::string_view(surfel_mark_desc, 15)),::luisa::compute::Type::from(luisa::string_view(multi_bounce_pixel_desc, 79)),::luisa::compute::Type::from(luisa::string_view(multi_bounce_pixel_counter_desc, 12)),::luisa::compute::Type::from(luisa::string_view(last_transform_buffer_desc, 17)),::luisa::compute::Type::from(luisa::string_view(args_desc, 214)),::luisa::compute::Type::from(luisa::string_view(size_desc, 14))};
...
::luisa::compute::ImageView<float> specular_dist_img,
::luisa::compute::ImageView<float> hitmv_img,
...
::luisa::compute::ComputeDispatchCmdEncoder _cmd_encoder(_shader->handle(), 31, _shader->uniform_size());
...
_cmd_encoder.encode_texture(specular_dist_img.handle(), specular_dist_img.level());
_cmd_encoder.encode_texture(hitmv_img.handle(), hitmv_img.level());
