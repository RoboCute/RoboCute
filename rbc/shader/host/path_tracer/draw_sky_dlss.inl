...
char _diffuse_desc[17] = {116,101,120,116,117,114,101,60,50,44,102,108,111,97,116,62,0};
...
auto arg_types = {::luisa::compute::Type::from(luisa::string_view(_emission_desc, 16)),::luisa::compute::Type::from(luisa::string_view(_depth_desc, 16)),::luisa::compute::Type::from(luisa::string_view(_normal_roughness_desc, 16)),::luisa::compute::Type::from(luisa::string_view(_mv_desc, 16)),::luisa::compute::Type::from(luisa::string_view(_spec_albedo_desc, 16)),::luisa::compute::Type::from(luisa::string_view(_albedo_desc, 16)),::luisa::compute::Type::from(luisa::string_view(_confidence_desc, 16)),::luisa::compute::Type::from(luisa::string_view(_diffuse_desc, 16)),::luisa::compute::Type::from(luisa::string_view(heap_desc, 14)),::luisa::compute::Type::from(luisa::string_view(sky_idx_desc, 4)),::luisa::compute::Type::from(luisa::string_view(default_depth_desc, 5)),::luisa::compute::Type::from(luisa::string_view(resource_to_rec2020_mat_desc, 9)),::luisa::compute::Type::from(luisa::string_view(world_2_sky_mat_desc, 9)),::luisa::compute::Type::from(luisa::string_view(inv_vp_desc, 9)),::luisa::compute::Type::from(luisa::string_view(cam_pos_desc, 15)),::luisa::compute::Type::from(luisa::string_view(jitter_desc, 15))};
...
::luisa::compute::ImageView<float> _diffuse,
...
::luisa::compute::ComputeDispatchCmdEncoder _cmd_encoder(_shader->handle(), 16, _shader->uniform_size());
...
_cmd_encoder.encode_texture(_diffuse.handle(), _diffuse.level());
