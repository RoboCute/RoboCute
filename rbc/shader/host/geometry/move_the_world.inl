...
char offset_desc[16] = {118,101,99,116,111,114,60,102,108,111,97,116,44,51,62,0};

auto arg_types = {::luisa::compute::Type::from(luisa::string_view(accel_desc, 5)),::luisa::compute::Type::from(luisa::string_view(last_transform_desc, 17)),::luisa::compute::Type::from(luisa::string_view(offset_desc, 15))};
...
_cmd_encoder.encode_uniform(std::addressof(offset), 16, 16);
