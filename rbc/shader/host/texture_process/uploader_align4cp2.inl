...
char src_desc[13] = {98,117,102,102,101,114,60,117,105,110,116,62,0};
char indices_desc[13] = {98,117,102,102,101,114,60,117,105,110,116,62,0};

auto arg_types = {::luisa::compute::Type::from(luisa::string_view(dst_desc, 12)),::luisa::compute::Type::from(luisa::string_view(src_desc, 12)),::luisa::compute::Type::from(luisa::string_view(indices_desc, 12))};
...
::luisa::compute::BufferView<uint32_t> src,
