...
namespace rbc::world {
static rbc::shared_atomic_mutex _ser_callback_mtx;
static luisa::unordered_map<luisa::string, luisa::move_only_function<void(void *)>> _ser_callback;
