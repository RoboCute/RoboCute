...
struct RBC_RUNTIME_API IResource {
    virtual ~IResource();
    virtual void OnInstall() {}
    virtual void OnUninstall() {}
};

struct RBC_RUNTIME_API ResourceHandle {
public:
    ResourceHandle();
...
struct RBC_RUNTIME_API ResourceHeader {
    uint32_t version{~0u};
    vstd::Guid guid;
...
struct RBC_RUNTIME_API ResourceRequest {
...
struct RBC_RUNTIME_API ResourceRecord {
...
struct RBC_RUNTIME_API ResourceRegistry {
public:
...
struct RBC_RUNTIME_API LocalResourceRegistry {
public:
...
struct RBC_RUNTIME_API ResourceFactory {
...
struct RBC_RUNTIME_API ResourceSystem {
...
RBC_RUNTIME_API ResourceSystem *GetResourceSystem();
