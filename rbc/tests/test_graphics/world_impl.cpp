...
int AnimSequence::get_num_soa_tracks(void *this_) {
    if (!this_) [[unlikely]] {
        LUISA_ERROR("AnimSequence::get_num_soa_tracks: this_ is null.");
        return -1;
    }
...
int AnimSequence::get_num_tracks(void *this_) {
    if (!this_) [[unlikely]] {
        LUISA_ERROR("AnimSequence::get_num_tracks: this_ is null.");
        return -1;
    }
    auto c = static_cast<rbc::world::AnimSequence *>(this_);
...
void AnimSequence::get_animation_pose(void *this_, void *pose_data, void *extract_context) {
    if (!this_) [[unlikely]] {
        LUISA_ERROR("AnimSequence::get_animation_pose: this_ is null.");
        return;
    }
    auto c = static_cast<rbc::world::AnimSequence *>(this_);
...
void *AnimSequenceResource::ref_seq(void *this_) {
    if (!this_) [[unlikely]] {
        LUISA_ERROR("AnimSequenceResource::ref_seq: this_ is null.");
        return nullptr;
    }
