...
void export_matrix(py::module &m) {
    ...
    py::class_<float3x3>(m, "float3x3")
        ...
        .def(py::init([](float m00, float m01, float m02, float m10, float m11, float m12, float m20, float m21, float m22) { return make_float3x3(m00, m01, m02, m10, m11, m12, m20, m21, m22); }))
    ...
    py::class_<float4x4>(m, "float4x4")
        ...
        .def(py::init([](float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float m20, float m21, float m22, float m23, float m30, float m31, float m32, float m33) { return make_float4x4(m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31, m32, m33); }))
    ...
    m.def("make_float3x3", [](
                               ...
                               float m20, float m21, float m22) { return make_float3x3(m00, m01, m02, m10, m11, m12, m20, m21, m22); });
    ...
    m.def("make_float4x4", [](
                               ...
                               float m30, float m31, float m32, float m33) { return make_float4x4(m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31, m32, m33); });
    ...
    py::class_<double2x2>(m, "double2x2")
        // .def("identity", [](){return double2x2();})
        .def("__getitem__", [](double2x2 &self, size_t i) { return &self[i]; }, py::return_value_policy::reference_internal)
        .def("__setitem__", [](double2x2 &self, size_t i, double2 k) { self[i] = k; })
        .def("copy", [](double2x2 &self) { return double2x2(self); })
        .def(py::init([](double a) { return make_double2x2(a); }))
        .def(py::init([](double a, double b, double c, double d) { return make_double2x2(a, b, c, d); }))
        .def(py::init([](double2 a, double2 b) { return make_double2x2(a, b); }))
        .def(py::init([](double2x2 a) { return make_double2x2(a); }))
        .def(py::init([](double3x3 a) { return make_double2x2(a); }))
        .def(py::init([](double4x4 a) { return make_double2x2(a); }))
        .def("__repr__", [](double2x2 &self) { return format("double2x2([{},{}], [{},{}])",
                                                             self[0].x, self[0].y, self[1].x, self[1].y); });

    py::class_<double3x3>(m, "double3x3")
        // .def("identity", [](){return double3x3();})
        .def("__getitem__", [](double3x3 &self, size_t i) { return &self[i]; }, py::return_value_policy::reference_internal)
        .def("__setitem__", [](double3x3 &self, size_t i, double3 k) { self[i] = k; })
        .def("copy", [](double3x3 &self) { return double3x3(self); })
        .def(py::init([](double a) { return make_double3x3(a); }))
        .def(py::init([](double m00, double m01, double m02, double m10, double m11, double m12, double m20, double m21, double m22) { return make_double3x3(m00, m01, m02, m10, m11, m12, m20, m21, m22); }))
        .def(py::init([](double3 a, double3 b, double3 c) { return make_double3x3(a, b, c); }))
        .def(py::init([](double2x2 a) { return make_double3x3(a); }))
        .def(py::init([](double3x3 a) { return make_double3x3(a); }))
        .def(py::init([](double4x4 a) { return make_double3x3(a); }))
        .def("__repr__", [](double3x3 &self) { return format("double3x3([{},{},{}], [{},{},{}], [{},{},{}])",
                                                             self[0].x, self[0].y, self[0].z, self[1].x, self[1].y, self[1].z, self[2].x, self[2].y, self[2].z); });

    py::class_<double4x4>(m, "double4x4")
        // .def("identity", [](){return double4x4();})
        .def("__getitem__", [](double4x4 &self, size_t i) { return &self[i]; }, py::return_value_policy::reference_internal)
        .def("__setitem__", [](double4x4 &self, size_t i, double4 k) { self[i] = k; })
        .def("copy", [](double4x4 &self) { return double4x4(self); })
        .def(py::init([](double a) { return make_double4x4(a); }))
        .def(py::init([](double m00, double m01, double m02, double m03, double m10, double m11, double m12, double m13, double m20, double m21, double m22, double m23, double m30, double m31, double m32, double m33) { return make_double4x4(m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31, m32, m33); }))
        .def(py::init([](double4 a, double4 b, double4 c, double4 d) { return make_double4x4(a, b, c, d); }))
        .def(py::init([](double2x2 a) { return make_double4x4(a); }))
        .def(py::init([](double3x3 a) { return make_double4x4(a); }))
        .def(py::init([](double4x4 a) { return make_double4x4(a); }))
        .def("__repr__", [](double4x4 &self) { return format("double4x4([{},{},{},{}], [{},{},{},{}], [{},{},{},{}], [{},{},{},{}])",
                                                             self[0].x, self[0].y, self[0].z, self[0].w, self[1].x, self[1].y, self[1].z, self[1].w,
                                                             self[2].x, self[2].y, self[2].z, self[2].w, self[3].x, self[3].y, self[3].z, self[3].w); });
    ...
    m.def("make_double3x3", [](
                                double m00, double m01, double m02,
                                double m10, double m11, double m12,
                                double m20, double m21, double m22) { return make_double3x3(m00, m01, m02, m10, m11, m12, m20, m21, m22); });
    ...
    m.def("make_double4x4", [](
                                double m00, double m01, double m02, double m03,
                                double m10, double m11, double m12, double m13,
                                double m20, double m21, double m22, double m23,
                                double m30, double m31, double m32, double m33) { return make_double4x4(m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31, m32, m33); });
