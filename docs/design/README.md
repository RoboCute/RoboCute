# RoboCute Design Documents

本目录包含 RoboCute 的设计文档。
...
- **[project_initialization.md](../dev/project_initialization.md)** - 项目初始化实现 ⭐
- **[implementation_checklist.md](../dev/implementation_checklist.md)** - 实现任务清单 ✅
